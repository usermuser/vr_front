...
set shortmess=aoO
badd +1 vrapp/models.py
badd +8 vrapp/views.py
badd +1 vrapp/urls.py
badd +1 vr/settings.py
badd +1 proj_urls_n_templates
badd +5 vrapp/templates/vrapp/index.html
badd +1 vr/urls.py
badd +1 vrapp/templates/vrapp/process_list.html
argglobal
silent! argdel *
edit vrapp/models.py
...
exe '4resize ' . ((&lines * 24 + 26) / 52)
exe 'vert 4resize ' . ((&columns * 98 + 98) / 197)
tabedit vrapp/templates/vrapp/process_list.html
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
